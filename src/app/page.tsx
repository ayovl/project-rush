              ...
              {(!user || (user && (!plan || plan === 'none'))) && (
                <div className="flex flex-col items-center mb-4">
                  <motion.button
                    ...
                    className="inline-flex items-center bg-gradient-to-r from-[#00B8E6] to-[#0099CC] text-white font-bold px-5 sm:px-7 py-3.5 sm:py-3.5 rounded-xl sm:rounded-xl shadow-xl hover:shadow-[0_0_30px_rgba(0,209,255,0.4)] transition-all duration-300 text-base sm:text-lg"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.98 }}
                  >
