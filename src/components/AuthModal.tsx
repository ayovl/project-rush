            ...
            <div className="w-full max-w-md bg-gradient-to-br from-gray-900/90 to-gray-800/90 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="p-6">
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full mb-4 px-4 py-2 bg-white hover:bg-gray-50 text-gray-900 font-medium rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#00D1FF]/50 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center space-x-2"
                >
                ...
                <div className="relative mb-4">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-gradient-to-br from-gray-900/90 to-gray-800/90 text-white/60">or continue with email</span>
                  </div>
                </div>
